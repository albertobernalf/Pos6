...
def ImprimirHojaAdmision(request):
    ...
    pdf.ln(2)
    pdf.cell(200, 62,
             'en calidad de paciente y/o acudiente del paciente:___________________________ con documento de identificación numero:_______________, donde resulto afectado por vehiculo automotor en movimiento.:',
             0, 0, 'L')
    pdf.ln(2)
    pdf.cell(200, 63,
