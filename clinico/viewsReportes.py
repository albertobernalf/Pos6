...
def ImprimirOrdenTerapia(ingresoId2, historiaId):
    # Instantiation of inherited class
    ...
    pdf = PDFOrdenTerapia(tipoDocId,documentoId, consec, historiaId)
    pdf.alias_nb_pages()
    pdf.set_margins(left=10, top=5, right=5)
    pdf.add_page()
    pdf.set_font('Times', '', 8)
...
def ImprimirOrdenRadiologia(ingresoId2, historiaId):
    # Instantiation of inherited class
    ...
    pdf = PDFOrdenRadiologia(tipoDocId,documentoId, consec, historiaId)
    pdf.alias_nb_pages()
    pdf.set_margins(left=10, top=5, right=5)
    pdf.add_page()
    pdf.set_font('Times', '', 8)
...
def ImprimirOrdenMedicamentos(ingresoId2, historiaId):
    # Instantiation of inherited class
