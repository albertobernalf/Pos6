...
def Load_dataMedicamentosEnfermeria(request, data):
    ...
    for id, tipoDoc, documento, paciente, folio,  consecutivoMedicamento, cantidad,  UnidadMedida, medicamento, via, frecuencia, diasTratamiento in curx.fetchall():
